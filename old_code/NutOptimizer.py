...
class NutOptimizer:
    ...
    def optimize_all(self, optimization_col: str, var_type='INTEGER', optimization_type='min', verbose: bool = True, timeout: int = 300):
        ...
        for constraint in self.constraints:
            self.optimize_one(constraint, optimization_col, var_type,
    ...
    def optimize_one(self, constraint_name: str, optimization_col: str, var_type='INTEGER', optimization_type='min', verbose: bool = True, timeout: int = 300):
        ...
        if optimization_type.lower() == 'max':
            m.objective = maximize(
                xsum(x[i] * self.data[optimization_col][i] for i in num_items))
