...
user_input = {
    "chosenItems": ["Chicken Breast", "Bread", "Milk"],  # Example user input as a list
    "checkboxSodium": True,
...
main_data.to_csv('initial1_rec.csv', index=False)
...
# datset4.to_csv('datset4.csv', index=False)
...
# datset5.to_csv('datset5.csv', index=False)
